/*
Gives the first year when a firm started to import a specific bec product category from one of the countries (CZ,SK,RO and RU)
Inputs:
	hs6bec.csv
	im91.dta
	...
...
import delimited using "`in'/hs6bec.csv", clear
...
drop if bec==""
drop bec*_*
reshape wide minyear, i(id8 bec) j(country) string
reshape wide minyear??, i(id8) j(bec) string
rename id8 tax_id
save "`out'/importer_panel_bec.dta", replace
